    ...
    public void SetSelectedCommanderImages( Commander commanderScript ) {
        ...
        if( this.currentlySelectedCommander == null) {
            ...
            if( potentialSelectedCommander != null) {
                ...
                selectedCommanderScript.SetCommanderAttributes(commanderScript.commanderName, selectedCommanderPrefab, commanderScript.selectedCommanderPrefabPath, selectedCommanderScript.hp, selectedCommanderScript.handSize, commanderScript.commanderData, commanderScript.playerId, commanderScript.abilityChargeCost);
